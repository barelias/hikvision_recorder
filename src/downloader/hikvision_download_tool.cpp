...
std::string NetDVRTime::str()
{
    ...
    res << std::setfill('0') << std::setw(2) << (int)dvr_time.dwYear << "-" << std::setfill('0') << std::setw(2) << (int)dvr_time.dwMonth << "-" << std::setfill('0') << std::setw(2) << (int)dvr_time.dwDay << "T" << std::setfill('0') << std::setw(2) << (int)dvr_time.dwHour << ":" << std::setfill('0') << std::setw(2) << (int)dvr_time.dwMinute << ":" << std::setfill('0') << std::setw(2) << (int)dvr_time.dwSecond;
    return res.str();
}
...
int HikvisionDownloader::setup_playback_by_time(NetDVRTime struStartTime, NetDVRTime struStopTime, std::string dst)
{
    ...
    std::cout << block.str() << "    " << block_to_compare.str() << std::endl;
